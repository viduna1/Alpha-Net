{
    ...
    "STRINGS": {
        "julie": {
            ...
            "WARN": "Warn",
            "REVOKED": "```Group link revoked!```",
            "REVOKE_DESC": "```Revokes group link```"
        ...
        "heroku": {
            "RESTART_DESC": "Restart Julie",
            "RESTART_MSG": "```Restarting...```",
            "SHUTDOWN_DESC": "Shutdown Julie",
        ...
        "filters": {
            ...
            "KICK": "Kicks who uses bad words",
            "KICK2":"fill your bad word in this",
        ...
        "updater": {
            ...
            "AFTER_UPDATE": "*JulieMwol Restarting !*",
        ...
        "notes": {
            ...
            "UNSUCCESSFUL": "Could not add note, please try again later or contact Julie developers.",
